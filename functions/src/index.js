...
exports.sendPushNotification = exports.handleSubscriptionUpdated = exports.createSubscription = exports.createStripeCustomer = void 0;
...
exports.handleSubscriptionUpdated = functions.https.onRequest((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendPushNotification = functions.firestore
    ...
    const userDoc = yield admin.firestore().collection('users').doc(userId).get();
    const user = userDoc.data();
    if (!(user === null || user === void 0 ? void 0 : user.notificationsEnabled)) {
        return;
    }
    const message = {
        notification: {
